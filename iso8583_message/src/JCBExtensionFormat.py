from ..ISO8583Message import TLVField,CustomField


# Bit 43: Card Acceptor Name/Location
bit43Format = {
    "s1": CustomField(43, "s1", 25, "Card Acceptor Name", "A"),
    "s2": CustomField(43, "s2", 45, "Address1: Street Address", "A"),
    "s3": CustomField(43, "s3", 13, "Address2: City", "A"),
    "s4": CustomField(43, "s4", 10, "ZIP code", "A"),
    "s5": CustomField(43, "s5", 3, "State code", "A"),
    "s6": CustomField(43, "s6", 3, "Country Code", "A")
}

# Bit 54: Amounts, Additional (For DCC transaction and ATM Access Fee transaction)
bit54Format = {
    "s1": CustomField(54, "s1", 2, "Account Type", "A"), #fix value : 00
    "s2": CustomField(54, "s2", 2, "Amount Type", "A"),
    "s3": CustomField(54, "s3", 3, "Currency Code", "A"),
    "s4": CustomField(54, "s4", 1, "Currency Code", "A"),
    "s5": CustomField(54, "s5", 12, "Amount", "M"),
}
...
bit97Format = {
    "s1": CustomField(97, "s1", 1, "Credit/Debit Indicator", "A"), 
    "s2": CustomField(97, "s2", 16, "Net Amount in Reconciliation Currency", "M"),
}
